                                ...
                                <ul class="dropdown-menu dropdown-menu-large row">
                                    <li class="col-md-4">
                                        <ul>
                                            ...
                                            <li><a href="{{ route('admin.manageadmin') }}">Admin Mangement</a></li>
                                            <li><a href="{{ route('admin.managegroup') }}">Group Management</a></li>
                                            <li><a href="{{ route('admin.managerole') }}">Role Mangement</a></li>
                                        </ul>
                                    </li>
                                    <li class="col-md-4">
                                        <ul>
                                            <li class="dropdown-header">Module</li>
                                            <li><a href="{{ route('admin.module') }}">Module Management</a></li>
                                        </ul>
                                    </li>
                                    <li class="col-md-4">
                                        <ul>
                                    ...
                                    <li class="col-md-4">
                                        <ul>
                                            ...
                                            @if(Auth::user()->hasRole('RoomManagement-View'))
                                                <li><a href="{{ route('admin.master.room') }}">Room List</a></li>
                                            @endif
