        ...
        <form id="saveprofile" class="form-vertical" method="POST" action="{{ route('user.profile.update') }}">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    {{ Form::select('identity_type_id', \App\Models\BaseModel\IdentityType::getList(), [isset($user->personal_data->institution) ? $user->personal_data->identity_type : 0], ["class" => "form-control select2-single"]) }}
