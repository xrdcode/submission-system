        ...
        <form id="saveprofile" class="form-vertical" method="POST" action="{{ route('user.profile.update') }}">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    {{ Form::select('identity_type_id', \App\Models\BaseModel\IdentityType::getList(), [isset($user->personal_data->identity_type) ? $user->personal_data->identity_type_id : ""], ["class" => "form-control select2-single"]) }}
