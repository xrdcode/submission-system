...
@section('body')
    ...
    <form id="assign_room" class="form-horizontal" method="POST" action="{{ isset($action) ? $action : "-" }}">
        ...
        <div class="form-group">
            <label for="name" class="col-md-4 control-label">Submission Title</label>

            <div class="col-md-6">
                <select id="submission_list" name="submission_id" data-src="{{ url('admin/submission/room/submission_slist') }}"></select>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <input id="datetimes" type="text" class="form-control" name="datetimes" value="{{ old('datetimes') }}" readonly required>
                    </div>
                </div>
            </div>
        </div>
