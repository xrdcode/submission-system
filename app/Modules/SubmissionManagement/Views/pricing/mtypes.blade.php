    ...
    <form id="newtype" class="form-horizontal" method="POST" action="{{ isset($action) ? $action : "" }}">
        ...
        <div id="eventselect" class="form-group">
            ...
            <div class="col-md-6 col-md-4">
                <input type="text" class="form-control" name="name" value="{{ $type->name }}" autocomplete="off">
            </div>
        </div>
        ...
        <div id="typeselect" class="form-group">
            ...
            <div class="col-md-6 col-md-4">
                <input type="text" class="form-control" name="description" value="{{ $type->description }}" autocomplete="off">
            </div>
        </div>
    </form>
@endsection
